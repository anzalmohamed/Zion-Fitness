    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        msignup.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (msignupemail.getText().toString().contentEquals("")) {


                    errorView.setText("Email cannot be empty");


                } else if (msignuppassword.getText().toString().contentEquals("")) {
                    ...
                    mAuth.createUserWithEmailAndPassword(msignupemail.getText().toString(), msignuppassword.getText().toString()).addOnCompleteListener(SignUpActivity.this, new OnCompleteListener<AuthResult>() {
                        @Override
